...
class WeekmenuServiceTest {
    ...
    void generateWeekmenu() {
        ...
        tags.add(new TagAmount(tag1, 2));
        tags.add(new TagAmount(tag2, 2));
        tags.add(new TagAmount(tag3, 3));

        WeekmenuRequirements requirements = new WeekmenuRequirements(tags);
        ...
        //act
        Weekmenu weekmenu = weekmenuService.GenerateWeekmenu(requirements, dishes);

        //assert
        assertEquals(7, weekmenu.getWeekmenuDishes().size());
    }
}